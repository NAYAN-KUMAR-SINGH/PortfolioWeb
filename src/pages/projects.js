...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
	return (
		<article className="w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light
		 dark:bg-dark shadow-2xl p-12 relative dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
...
const Project = ({ type, title,  img, link, github }) => {
	return (
		<article className="w-full flex flex-col items-center justify-center rounded-3xl border border-solid border-dark dark:border-light bg-light
		 dark:bg-dark  p-6 relative shadow-2xl xs:p-4">
			<div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] rounded-br-3xl bg-dark dark:bg-light md:-right-2 md:w-[102%] xs:rounded-[1.5rem]" />
			<Link href={link} target="_blank"
...
const projects = () => {
	return (
		<>
			<Head>
				<title>Aditya Kumar | Projects Page</title>
