...
const Article = ({ img, title, date, link }) => {
	return (
		...
		items-center justify-between bg-light text-dark first:mt-0 border border-solid border-dark dark:border-light
		border-r-4 border-b-4 dark:bg-dark dark:text-light sm:flex-col">
...
const articles = () => {
	return (
		<>
			<Head>
				<title>Aditya Kumar | Articles Page</title>
